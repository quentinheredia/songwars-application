  ...
  return (
    ...
    >
      ...
      <fieldset className="form-section">
        <legend>
          <span>01</span> Performance profile
        </legend>
        <div className="form-grid two-columns">
          ...
          />
          <FormField
            label="How many times have you performed live?"
        ...
        <div className="form-grid">
          ...
          <div className="form-grid two-columns">
            <FormField
              ...
              name="spotify_handle"
              required
              placeholder="Link, handle, or N/A"
            />
            <FormField
              label="SoundCloud"
              name="soundcloud_handle"
              required
              placeholder="Link, handle, or N/A"
            />
          </div>
          <FormField
            label="Other music platform"
            name="other_music_links"
            required
      ...
      <fieldset className="form-section">
        <legend>
          <span>03</span> Your music
        </legend>
        <div className="genre-field">
          <span className="field-label">
            What genres best describe your music? <b>*</b>
          </span>
      ...
      <label className="form-consent">
        ...
        <span>
          I have the right to submit this music and agree to be contacted about
          Live Song War. <b>*</b>
        </span>
      </label>
  ...
  return (
    <label className="form-field">
      ...
      <input
        {...inputProps}
        required={required}
        maxLength={inputProps.type === "number" ? undefined : 500}
      />
    </label>
  );
}
